...
<div class="modal fade" id="change_password" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../../../res api/users account/users/chairperson/attributes/change password/index.php?id=research work" method="post">
    ...
    <div class="modal-content">
      ...
      <form action="../../../../res api/users account/users/chairperson/research work/editResearch.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="college" value="<?php echo $fetch['college']; ?>">
            <input type="hidden" name="historyRorE" value="<?php echo $fetch['historyRorE']; ?>">
            <input type="hidden" name="historyCampus" value="<?php echo $fetch['historyCampus']; ?>">
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../../res api/users account/users/chairperson/attributes/edit profile/index.php?check=research work" method="POST" enctype="multipart/form-data">
...
<!-- Left navbar links -->
    ...
    <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown" style="margin-left:-300px; width:300px; text-align:center">
          <form action="../../../../res api/users account/users/chairperson/create document/index.php" method="POST">
      ...
      <div class="card-body table-responsive p-0" style="height: 450px;">
        ...
        <!-- =================================== ALL RESEARCH DATA ===================================================== -->
            ...
            <?php 
              ...
              $campus = $fetch['campus'];
              $mysql = $conn->prepare("SELECT * FROM all_research_data WHERE campus = :campus AND RorE = :RorE AND college = :college AND isDelete = :isDelete");
              $mysql->execute(['campus' => $campus, 'RorE' => $RorE, 'college' => $college, 'isDelete' => "not"]);
                ...
                if ($row['college'] != ""){ ?>
                  ...
                  <tr class="hover">
                    <td style="display:none"><?php echo $row['id']; ?></td>
                      ...
                      <td data-title="Added By: "><?php if ($row['added_by'] == "Chairperson"){ echo "You"; }else{ echo $row['added_by']; } ; ?></td>
                  ...
                  <tr>
                    ...
                    <td>
                      <form method="post">
                          <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"></a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                          <li><a href="../../../../res api/users account/users/chairperson/download history/index.php?id=<?php echo $historyRow['id']; ?>" class="dropdown-item">Download</a></li>
                        </ul></i></a>
                      </form>
                    </td>
...
<script>
    ...
    const foundMatch = research.includes(searchString) || authors.includes(searchString) || status.includes(searchString);
