  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../../../res api/users account/users/unit head/attributes/change password/index.php?id=schedule" method="post">
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../../res api/users account/users/unit head/attributes/change profile/index.php?check=schedule" method="POST" enctype="multipart/form-data">
    ...
    <div class="content-wrapper" id="container" style="">
      ...
      <div class="left-side" style="background-color:rgb(197, 203, 223)">
        ...
        <table id="myTable">
          <tbody>
            ...
            <?php
              $table = $conn->prepare("SELECT * FROM schedule_presentation WHERE send_unit_head = :send_unit_head AND chairperson = :chairperson AND isDelete = :isDelete");
              $table->execute(['send_unit_head' => "Unit Head", 'chairperson' => "Approved", 'isDelete' => "not"]);
      ...
      <div class="right-side" style="background-color:#f2f2f2f2; padding-left:40px; padding-right:40px; display:none" id="main">
        ...
        <div style="display:relative;">
          ...
          <form action="../../../../res api/users account/users/unit head/save schedule/index.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group" style="position:absolute; margin-left:calc(70% - 18px);">
            <label for=""></label>
            <form action="../../../../res api/users account/users/unit head/send schedule/index.php" method="POST">
    ...
    function displayData(row) {
      ...
      if (data[0] == ""){
        ...
        if (data[7] == "Approved"){
          ...
          document.getElementById('forwardButton').setAttribute("style", "margin-right:30px");
          document.getElementById('forwardButton').innerHTML = "Forward To Admin";
          document.getElementById('myUnitHead1').innerHTML = data[7]+"...";
