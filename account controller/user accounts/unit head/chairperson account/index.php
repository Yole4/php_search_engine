  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img style="height:34px; width:34px" src="../../../../res api/users account/users/unit head/attributes/profile upload/<?=$fetch['image']; ?>" class="img-profile rounded-circle">
        </div>
        <div class="info">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../../../res api/users account/users/unit head/attributes/change password/index.php?id=chairperson" method="post">
...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="../../../../res api/users account/users/unit head/chairperson/addChairperson.php" method="POST">

        <div class="modal-body">

            <input type="hidden" name="added_name" value="<?php echo $fetch['fullname']; ?>">
...
<div class="modal fade" id="yole123" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="../../../../res api/users account/users/unit head/chairperson/editChairperson.php" method="POST">

        <div class="modal-body">
            
            <input type="hidden" id="currentEmail" name="currentEmail" value="">
            <input type="hidden" id="update_id" name="my_id" value="">
            <input type="hidden" value="<?php echo $campus ?>" id="campusId">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img style="height:100px; width:100px" class="profile-user-img img-fluid img-circle" src="../../../../res api/users account/users/unit head/attributes/profile upload/<?=$fetch['image']; ?>" alt="User profile picture">
            </div>
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../../res api/users account/users/unit head/attributes/change profile/index.php?check=chairperson" method="POST" enctype="multipart/form-data">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"><span style="font-size:20px">Chairperson Accounts</span>  
            ...
            <div class="card">
              ...
              <table id="my-table">
                ...
                <tbody style = "display:visible" id="all_id">
                  ...
                  <?php 
                    $RorE = $fetch['RorE'];
                    $mysql = $conn->prepare("SELECT * FROM research_secretary WHERE campus = :campus AND RorE = :RorE AND added_by = :added_by AND rank = :rank AND isDelete = :isDelete");
                    $mysql->execute(['campus' => $campus, 'RorE' => $RorE, 'added_by' => "Unit Head", 'rank' => "Chairperson", 'isDelete' => "not"]);
                    ...
                    $count = $mysql->rowCount();
                      ...
                      if ($row['college'] != ""){?>
                        ...
                        <tr class="hover">
                          ...
                          <td>
                          <form action="../../../../res api/users account/users/unit head/chairperson/deleteChairperson.php?delete=<?php echo $row['id']; ?>" method="post">
...
<script>
  $(document).ready(function(){
    $('.edit_me').on('click', function(){
      ...
      var mycampus = document.getElementById("campusId").value;

      if (mycampus == "Dapitan"){
        //dapitans
        document.getElementById("dapitanId").value = data[4];

      }
      else if (mycampus == "Dipolog"){
        //dipologs
        document.getElementById("dipologId").value = data[4];
      }
      else if (mycampus == "Katipunan"){
        //Katipunan

        document.getElementById("katipunanId").value = data[4];
      }
      else if (mycampus == "Siocon"){
        //Siocon
        document.getElementById("sioconId").value = data[4];
      }
      else if (mycampus == "Sibuco"){
        //Sibuco

        document.getElementById("sibucoId").value = data[4];
      }
      else if (mycampus == "Tampilisan"){
        //Tampilisan

        document.getElementById("tampilisanId").value = data[4];
      }      
...
<script>
    ...
    const college = row.querySelector('td:nth-child(6)').textContent.toLowerCase();
    const foundMatch = fullname.includes(searchString) || email.includes(searchString) || college.includes(searchString);
