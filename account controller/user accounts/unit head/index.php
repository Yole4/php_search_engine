  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../../res api/users account/users/unit head/attributes/change password/index.php?id=home" method="post">
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../res api/users account/users/unit head/attributes/change profile/index.php?check=home" method="POST" enctype="multipart/form-data">
