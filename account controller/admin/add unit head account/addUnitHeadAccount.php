...
<head>
  ...
  <title>Unit Head Accounts</title>
...
<!-- =========================================================== UNIT HEAD ACCOUNTS ======================================================================================== -->
          ...
          <li class="nav-item has-treeview">
            <a href="addUnitHeadAccount.php" class="nav-link">
...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Unit Head</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="../../../res api/users account/Admin/add unit head/addUnitHead.php" method="POST" onsubmit="loading()">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="sec_campus" id="">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" id="myForm" name="addUnitHead" class="btn btn-primary">Add</button>
        </div>
      </form>
...
<div class="modal fade" id="yole123" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Unit Head</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="../../../res api/users account/Admin/add unit head/editUnitHead.php" method="POST" onsubmit="loading()">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label>Campus</label><br>
              <select class="form-control" name="campus" id="myCampus">
                <option value="Dapitan">Dapitan</option>
                <option value="Dipolog">Dipolog</option>
                <option value="Katipunan">Katipunan</option>
                <option value="Siocon">Siocon</option>
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../res api/users account/Admin/update profile/update.profile.php?check=unit head" method="POST" enctype="multipart/form-data" onsubmit="loading()">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"><span style="font-size:20px"><a href="">Unit Head Account</a></span>  
                  ...
                  <tbody style = "display:visible" id="all_id">
                    ...
                    <?php
                      ...
                      <tr class="hover">
                        ...
                        <td>
                        <form action="../../../res api/users account/Admin/add unit head/deleteUnitHead.php?delete=<?php echo $row['id']; ?>" method="post">
...
<script>
    ...
    const foundMatch = fullname.includes(searchString) || email.includes(searchString) || campus.includes(searchString) || RorE.includes(searchString);
