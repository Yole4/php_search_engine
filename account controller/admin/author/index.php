  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../../res api/users account/Admin/change/change.pass.php?id=author" method="post">
...
<div class="modal fade" id="yole123" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="../../../res api/users account/Admin/author/editAuthor.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="campus" onchange="choose_campuses()" id="campus_ids">
      ...
      <!--====================== KATIPUNAN =======================-->
      <input type="hidden" id="colleges" name="colleges">
  ...
  <div class="modal-dialog" role="document" style="width:400px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <form action="../../../res api/users account/Admin/update profile/update.profile.php?check=author" method="POST" enctype="multipart/form-data">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary"><span style="font-size:20px">Author Account
                  ...
                  <tbody style = "display:visible" id="all_id">
                    ...
                    <?php
                      ...
                      <tr class="hover">
                        ...
                        <td>
                        <form action="../../../res api/users account/Admin/author/deleteAuthor.php?delete=<?php echo $row['id']; ?>" method="post">
