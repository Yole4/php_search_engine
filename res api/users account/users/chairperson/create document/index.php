...
require_once("../../../../configuration/config.php");
    ...
    if (isset($_POST['generate'])){
        ...
        $count = count($result);
            ...
            $section->addText($college, array('size' => 20, 'align' => 'center'));
            $section->addText();
            ...
            foreach($result as $index => $row){
                if ($RorE == "Research"){
                    ...
                    if (($checker == $campus) && ($isDelete == "not")){
                        $collegeChecker = $row['college'];

                        if ($collegeChecker == $college){
                            $table->addRow();
            ...
            $filename = "$startDate - $eDate ($RorE - $campus - $college).docx";
