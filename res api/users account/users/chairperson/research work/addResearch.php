        ...
        if (in_array($file_actual, $allowed)){
            if ($file_error === 0){
                if ($file_size < 5242880){
                    ...
                    $checktitle = $conn->prepare("SELECT research FROM all_research_data WHERE research=:research AND isDelete = :isDelete");
                    ...
                    if ($checker){
                        header("Location: ../../../../../account controller/user accounts/chairperson/research works/index.php?success=$success");
                    }else{
