<?php
    ...
    if (isset($_GET['delete'])){
        ...
        if ($sql->execute(['id' => $id, 'isDelete' => "Deleted", 'notification' => 1])){
            ...
            header("Location: ../../../../../account controller/user accounts/chairperson/research works/index.php?success= Data has been successfully deleted!");
        }
        else{
            header("Location: ../../../../../account controller/user accounts/chairperson/research works/index.php?already=Something went wrong!");
        }
    }else{
        header("Location: ../../../../../index.php");
    }
