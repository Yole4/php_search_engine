<?php
    ...
    if (isset($_POST['submitButton'])){
        ...
        $anotherRemarks = $_POST['updateRemarks'];
        ...
        if ($file_size == 0){
            ...
            // if ($countSql > 0){
                header("Location: ../../../../../account controller/user accounts/author/schedule for presentation/schedulePresentation.php?success=Data has been saved!");
