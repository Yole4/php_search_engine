            ...
            if ($file_error === 0){
                if ($file_size < 5242880){
                    ...
                    try{
                        ...
                        $sql = "UPDATE all_research_data SET getname = :getname, college = :college, research = :research, authors = :authors, status = :status, proposed = :proposed, started = :started, completed = :completed, document = :document, file_name = :file_name WHERE id = :id";
                        ...
                        if ($good > 0){
                            ...
                            header("Location: ../../../../../account controller/user accounts/unit head/research work/index.php?success=Research has been successully updated!");
                        }
                        else{
                            header("Location: ../../../../../account controller/user accounts/unit head/research work/index.php?already=Faild to Add Data!");
                        }
