  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="../research/research.login.php" class="dropdown-item">Research </a></li>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-copy"></i> Publick Research</a>
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                  <li><a href="../../pages/Public Research/public.baliktad.php" class="dropdown-item">Research </a></li>
                  <li><a href="../../pages/Public Research/public_research.php" class="dropdown-item">Extension</a></li>
                </ul>
              ...
              <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="nav-icon fas fa-lock"></i> Login As</a>
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                  <li><a href="../research/research.login.php" class="dropdown-item">Research </a></li>
                  <li><a href="../extension/extension.login.php" class="dropdown-item">Extension</a></li>
                  <li><a href="admin.login.php" class="dropdown-item">Admin</a></li>
               ...
               <div class="col-lg-12">
                 <div class="p-5">
                   <div class="text-center">
                     <h1 class="h4 text-gray-900 mb-4" style="font-size:30px; font-style:bold">Login as Admin</h1>
                      ...
                      ?>
                     <form class="user" action="../../res api/users account/Admin/admin.login.php" method="POST">
                        <!-- <div class="form-group">
                            <select name="category" id="" class="input">
                                ...
                                <option value="#">Siocon</option>
                                <option value="#">Sibuco</option>
                                <option value="#">Tampilisan</option>
                            </select>
                        </div> -->
                         <div class="form-group">
                         ...
                         <script>
                          ...
                          <input type="submit" name="login" class="btn btn-primary btn-user btn-block" value="Login" style="font-size:25px">
                         <hr>
                     </form>
