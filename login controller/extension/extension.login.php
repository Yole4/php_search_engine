    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="extension.login.php" class="dropdown-item">Extension</a></li>
               ...
               <div class="col-lg-12">
                 <div class="p-5">
                   <div class="text-center">
                     <h1 class="h4 text-gray-900 mb-4" style="font-size:30px; font-style:bold">Extension Portal</h1>
                   </div>
                     ...
                     <form class="user" action="../../res api/users account/Extension/extension.login.php" method="POST">
